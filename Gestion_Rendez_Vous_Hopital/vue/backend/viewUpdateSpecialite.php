...
<div class="container col-lg-6">
    <div class="card">
        ...
        <div class="card-body">
            <form class="formulaire" action="index.php?action=updateSpecialite" method="POST">
                <div class="form-group">
                    <label for="nom">Specialite</label>
                    <input type="hidden" name="id" value="<?= $listeSpecialite['id_domaine']?>">
                    <input type="text" name="nom_specialite" id="specialite" placeholder="Votre Réponse" class="form-control"
                    value ="<?= $listeSpecialite['nom_specialite']?>">
                ...
                <div class="form-group">
                    <button class="btn btn-primary btn-block" style="background-color:#7451EB" type="submit" id="ok" >Modifier</button>
                </div>
            </form>
        </div>
    </div>
